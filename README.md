...
- This plugin now supports the browser platform using [https://github.com/sql-js/sql.js](https://github.com/), with no persistence and other limitations described below.
...
- The browser platform is now supported using [`sql-js/sql.js`](https://github.com/sql-js/sql.js) (with no persistence and some other limitations described below).
...
As stated above the browser platform is now supported with features such as numbered parameters now working using [`sql-js/sql.js`](https://github.com/sql-js/sql.js), with no actual persistence.
