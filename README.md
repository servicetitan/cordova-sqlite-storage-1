...
| [`cordova-sqlite-evcore-extbuild-free`](https://github.com/storesafe/cordova-sqlite-evcore-extbuild-free) | with lighter resource usage in Android NDK | GPL v3 | available, see <https://storesafe.io/> or contact <sales@storesafe.io> |
...
| [`cordova-sqlite-express-build-support`](https://github.com/storesafe/cordova-sqlite-express-build-support) | using built-in SQLite libraries on Android, iOS, and macOS - may be missing some important updates | MIT (or Apache 2.0 on Android & Windows) | available - contact <sales@storesafe.io> |
...
- Some extremely large records may not work with this plugin version, especially on Android. It is recommended to store images and similar binary data in separate files. There is [`storesafe/cordova-plugin-sqlite-evplus-ext-common-free`](https://github.com/storesafe/cordova-plugin-sqlite-evplus-ext-common-free) with a workaround for extra-large result data on Android (GPL v3 or commercial license terms).
