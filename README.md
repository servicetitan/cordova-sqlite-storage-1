...
NOTE: These samples will **not** work with alternative 3 for browser platform support discussed in [**alternative browser platform usage notes**](#alternative-browser-platform-usage-notes) section below.
...
NOTE: This call will **not** work with alternative 3 for browser platform support discussed in [**alternative browser platform usage notes**](#alternative-browser-platform-usage-notes) section above.
...
NOTE: This call will **not** work with alternative 3 for browser platform support discussed in [**alternative browser platform usage notes**](#alternative-browser-platform-usage-notes) above.
