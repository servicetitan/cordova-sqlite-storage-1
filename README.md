...
- This plugin now supports the browser platform using [`sql-js/sql.js`](https://github.com/sql-js/sql.js), with no persistence and other limitations described below.
